...
1- set up project
2- scaffold our application's architecture - structure to use Sequelize and Express.js to keep the code organized
3 - Create the user model - we'll use sequelize's model syntax to set up what will become the user table in the database
4- Create API routes for the user model - we'll create API endpoints using the REST paradigm to perform CRUD operations on the user model's data.